...
func TestBuildScheduleInjectsFiller(t *testing.T) {
	...
	s, err := tBuild(t.Context(), p, "c", []string{dir}, testExtensions, "sequential", testSeasonPatterns, testEpisodePatterns, filler, nil, now)
	if err != nil {
		t.Fatal(err)
	}
...
func TestRebuildReusesUnchangedFiller(t *testing.T) {
	...
	build := func(old *Schedule) *Schedule {
		s, err := tBuild(t.Context(), p, "c", []string{dir}, testExtensions, "sequential", testSeasonPatterns, testEpisodePatterns, filler, old, now)
		if err != nil {
			t.Fatal(err)
		}
		return s
...
func TestFillerShuffleSeededIndependentlyOfContent(t *testing.T) {
	...
	s2, err := tBuild(t.Context(), p, "c", []string{dir}, testExtensions, "sequential", testSeasonPatterns, testEpisodePatterns, filler, s, now)
	if err != nil {
		t.Fatal(err)
	}
...
func TestBuildRotatesSurplusFillerAcrossRebuilds(t *testing.T) {
	...
	build := func(old *Schedule) (*Schedule, error) {
		return tBuild(t.Context(), p, "c", []string{dir}, testExtensions, "sequential", testSeasonPatterns, testEpisodePatterns, filler, old, now)
	}
...
func TestRebuildReinterleavesFillerAfterReorder(t *testing.T) {
	...
	build := func(eps []*regexp.Regexp, old *Schedule) *Schedule {
		s, err := tBuild(t.Context(), p, "c", []string{dir}, testExtensions, "sequential", testSeasonPatterns, eps, filler, old, now)
		if err != nil {
			t.Fatal(err)
		}
		return s
