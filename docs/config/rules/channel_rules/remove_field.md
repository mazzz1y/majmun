...
| ----------- | ------------------------------ | -------- | ---------------------------------------- |
| `selector`  | [`Selector`](../../shared/selector.md)   | Yes      | What to remove (attribute/tag)           |
| `condition` | [`Condition`](../../shared/condition.md) | No       | Optional, restricts which channels match |
